...
//	রুকাইয়া
	...
	public void addMember() throws InterruptedException,  AWTException{
		...
		//Set file directory in file paths
		UploadMethod.Upload("E:\\RDCD All Documents\\RDCD\\Automation 9step\\Upload_Images\\3.png");
		clickElement(PersonSignatureSelect_c);
		Thread.sleep(2000);
		UploadMethod.Upload("E:\\RDCD All Documents\\RDCD\\Automation 9step\\Upload_Images\\sign.jpg");
		clickElement(PersonDOcumentSelect_c);
		Thread.sleep(2000);
		UploadMethod.Upload("E:\\RDCD All Documents\\RDCD\\Automation 9step\\Upload_Images\\document.png");
		Thread.sleep(2000);
